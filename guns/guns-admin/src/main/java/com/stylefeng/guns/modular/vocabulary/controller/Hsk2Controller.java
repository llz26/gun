...
public class Hsk2Controller extends BaseController {
    ...
    public Object list(String condition) {
        EntityWrapper<Hsk2> entityWrapper= new EntityWrapper<>();
        Wrapper<Hsk2> wrapper = entityWrapper.eq("level",1);
        return hsk2Service.selectList(wrapper);
    }
